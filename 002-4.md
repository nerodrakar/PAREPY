...
<p align = "justify">
Uma vez que o resultado direto da Simulação de Monte Carlo (SMC) é a estimativa da probabilidade de falha \(p_f\), o índice de confiabilidade β pode ser determinado a partir desse valor, segundo a Equação (2.38) <code>and</code>, <code>or</code> e <code>not</code>. O <a href = "#qua33">Quadro 3.3</a> apresenta o conceito de cada um dos operadores.
</p>
