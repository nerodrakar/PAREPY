...
in order to enable the integration of Equation <a href="#eq1">(2)</a> over the entire domain. abc
...
<table border = "0" style = "width: 100%;">
  ...
  <tr>
    <td align = "left" style = "width: 95%;">\[ \mathbf{I} [\mathbf{X}] = {\begin{array}{l} 1, \: G\left ( X \right )\leq 0 &\\ 0, G\left ( X \right )> 0 \end{array}</td>
