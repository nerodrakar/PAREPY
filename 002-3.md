...
<table border = "0" style = "width: 100%;">
  <tr>
    <td align = "left" style = "width: 95%;">\[P_f = \left \int_{\forall X}^{}I\left [ X \right ]dX\]</td>
    <td align = "right" style = "width: 5%;"><p id = "eq3">(3)</p></td>
  </tr>
  <tr>
    <td align = "left" style = "width: 95%;">\[ \mathbf{I} \left[g(\mathbf{X}] = \left\{\begin{array}{l} 1, \: G\left ( X \right )\leq 0 &\\ 0, G\left ( X \right )> 0 \end{array} \right.  \]</td>
