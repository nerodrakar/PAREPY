...
where \(X^{i}\) represents the i-th sample of the vector of variables \(X\) generated from theprobability density function 𝑓𝑥(𝑋). In this way, the determination of \(P_f\) becomes carried out from Equation <a href="#eq1">(6)</a>:
